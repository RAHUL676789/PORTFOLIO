        ...
        <div className="Portfolio">
            ...
            <div className="SkillandProject">
                <div className="top-Skills">
                    ...
                    <div className="skill">
                        <h1>  <i class="fa-brands fa-react react"></i></h1>
                        ReactJS
                    </div>
                    <div className="skill">
                        <h1><i class="fa-brands fa-js javas"></i></h1>
                        Javascript
                    </div>
                    <div className="skill">
                        <h1><i class="fa-brands fa-node nodejs"></i></h1>
                        NodeJs
                    </div>
                    <div className="skill">
                        ...
                        MongoDB</div>
                    <div className="skill">
                        <h1><i class="fa-brands fa-square-github git"></i></h1>
                        Version Control</div>
                    <div className="skill">
                        <h1><i class="fa-brands fa-html5 ht"></i> &nbsp;<i class="fa-brands fa-css3-alt cs"></i></h1>
                        HTML & CSS
                    </div>
                </div>
